    ...
    <el-row class="main-view" :gutter="20">
        <el-col class="content-view" :span="24">
            ...
            <table cellspace="0" cellpadding="0" border="0">
                ...
                <tbody>
                    <tr v-for="row in sortedNodes" v-on:contextmenu="handleRowRightClick(row, $event)" v-on:click="handleRowClick(row, $event)" v-on:dblclick="handleRowDoubleClick(row, $event)" v-bind:class="{selected: row.isSelected}">
